...
public class ClientAdmin {
        ...
        private static void addNewClient() {
            ...
            clientInfo.addClient(clientID, clientName, clientAddress, clientContact, clientEmail, rentingStatus);
        }
        ...
        private static void updateClientInfo() {
            ...
            clientInfo.updateClient(clientID, newName, newAddress, newContact, newEmail, newRentingStatus);
        }
